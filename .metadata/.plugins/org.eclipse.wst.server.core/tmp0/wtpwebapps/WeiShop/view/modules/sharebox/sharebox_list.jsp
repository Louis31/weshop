...
<body>
	 ...
	 <form id="menuForm" style="margin:10;text-align: center;" method="post">
	  <table cellspacing="0" cellpadding="0">
        <tbody>
          ...
          <tr>
            <td>
              &nbsp; 按盒子名称查询：<input class="textbox" id="boxName" type="text" name="boxName">
	   ...
	   <table id="box_tb" style="height: 100%;width:100%"></table>	
	</div>
	...
	$(document).ready(function() {
		$('#box_tb').datagrid({
							...
							idField : 'backId',
							loadMsg : '正在加载....',
							url: '${BasePath}/backmanage/queryList?d='+new Date(),
							columns : [ [					
