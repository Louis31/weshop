...
Ext.onReady(function(){
    ...
    var UserStore = new Ext.data.JsonStore({
	    ...
	    listeners:{
	    	load:function(s){
	    		r = s.getAt(0);
	    		if(r){
	    			Ext.getCmp("usercombo").onSelect(r, 0);
	    		}
	    	}
	    }
	});
    ...
    var addForm = new Ext.FormPanel({
		...
		items:[{
				...
				listeners:{
					select : function(a,b){
						ckdForm.getForm().findField("username").setValue(b.data.text);
					}
				}
		},{
				name:'lxren',
