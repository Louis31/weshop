	            						  ...
	            						  if (panel && panel.closeAction == "hide") {   
	            							  ...
	            							  setValue: function (value) {   
	            								  ...
	            								  return me.mixins.field.setValue.call(me, value);  
	            									  ...
	            									  v = (me.inputEl ? me.inputEl.getValue() : Ext.value(me.rawValue, ''));        me.rawValue = http://www.cnblogs.com/fei85454645/p/v;        return v;    },    destroyUEditor: function () {        var me = this;        if (me.rendered) {            try {                me.ue.destroy();                var dom = document.getElementById(me.id);                if (dom) {                    dom.parentNode.removeChild(dom);                }                me.ue = null;            } catch (e) { }        }    },    onDestroy: function () {        var me = this;        me.callParent();        me.destroyUEditor();    }});
	            	  }
	              }
}