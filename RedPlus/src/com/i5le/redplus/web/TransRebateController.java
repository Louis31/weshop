...
@Controller
@RequestMapping(value = "/rabate")
public class TransRebateController extends BaseCRUDController<TransRebate, Long> {

	@Autowired
	private TransRebateService rebateService;
	...
	public void getEntity(
			...
			Model model) {
		if (id != -1) {
			model.addAttribute("entity", this.rebateService.findOne(id));
		}
	}

	@Override
	protected BaseService<TransRebate, Long> getServcie() {
